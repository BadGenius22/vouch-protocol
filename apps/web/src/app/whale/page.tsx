              ...
              <div className="text-center py-8">
                ...
                {!wallet.publicKey ? (
                  <>
                    ...
                    <p className="text-neutral-400 mb-6">Connect your trading wallet to begin</p>
                    <WalletButton />
                  </>
                ) : (
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="text-center p-4 rounded-lg bg-white/5 border border-white/10">
                      ...
                      <p className="text-2xl font-mono font-bold text-white">{tradingData.tradeCount}</p>
                    </div>
                  </div>
                </div>
                ...
                {meetsThreshold ? (
                  ...
                  <div className="text-center p-4 rounded-xl bg-red-500/5 border border-red-500/20">
                    <p className="text-red-400 font-medium">Below $50K volume threshold</p>
                    <p className="text-sm text-neutral-500 mt-1">Keep trading to qualify as a whale</p>
                  </div>
                )}
              </div>
            )}
