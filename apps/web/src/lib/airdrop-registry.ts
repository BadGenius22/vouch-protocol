...
const DISCRIMINATORS = {
  ...
  registerForAirdrop: Buffer.from([
    0xa5, 0x2b, 0x76, 0xde, 0x42, 0x25, 0x4f, 0xb2,
  ]),
  registerForAirdropOpen: Buffer.from([
    0x6f, 0xe1, 0xe5, 0x49, 0x22, 0x2d, 0xde, 0xd4,
  ]),
  closeAirdropRegistration: Buffer.from([
    0xf2, 0x6d, 0x41, 0xe9, 0x1d, 0x7c, 0xf2, 0xa7,
  ]),
  markAirdropDistributed: Buffer.from([
    0x57, 0xb7, 0xf2, 0x54, 0x6a, 0x2b, 0x09, 0xd2,
  ]),
  completeAirdropCampaign: Buffer.from([
    0x47, 0xc0, 0xd0, 0xd9, 0xd8, 0x79, 0xbd, 0x3a,
  ]),
};
